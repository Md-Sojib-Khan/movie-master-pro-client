    ...
    return (
        <div className='w-11/12 mx-auto'>
            <div className='grid grid-cols-1 md:grid-cols-2 my-5 gap-5'>
                {
                    myMovies.map(movie => <div key={movie._id} className="card card-side flex-col md:flex-row bg-base-100 shadow-sm p-3 hover:scale-102 transition-transform hover:shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <button onClick={() => handleRemove(movie._id)} className="btn btn-error btn-sm md:btn-md gap-2 hover:scale-105 transition-transform"><FaTrash />Remove</button>
                            </div>
                        </div>
                    </div>)
                }
